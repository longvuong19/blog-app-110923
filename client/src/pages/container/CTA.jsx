      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            <h2 className="text-white font-roboto font-bold text-2xl text-center md:text-4xl md:leading-normal lg:text-left">
            ...
            <p className="text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
              ...
              if you submit by 9pm today. If we received after 9pm you will get
              ...
              <div className={`rounded-xl w-full bg-white p-3 z-[1] relative`}>
                ...
                <div className="p-5">
                  ...
                  <p className="text-dark-light mt-3 text-sm md:text-lg">
                    Our insurance plans offer are priced the same everywhere
                    else.
                  </p>
                </div>
              </div>
